...
class Plugin {
  ...
  on(eventName, callback) {
    const methodName = "on".concat(Object(_utils__WEBPACK_IMPORTED_MODULE_0__["upperFirst"])(eventName));
    const eventObject = runtime[methodName];

    if (!eventObject) {
      console.log("".concat(methodName, "\u7F3A\u5931"));
      return;
    }
...
const plugin = new _Plugin__WEBPACK_IMPORTED_MODULE_0__["default"]();
plugin.on('installed', () => {
  storage.sync.set({
    color: '#3aa757'
  }, () => {
...
/******/ });
//# sourceMappingURL=background-f32c17fc.js.map